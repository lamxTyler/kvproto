...
type PrewriteResponse struct {
	...
	LastReadTs  uint64         `protobuf:"varint,3,opt,name=last_read_ts,json=lastReadTs,proto3" json:"last_read_ts,omitempty"`
}
...
func (m *PrewriteResponse) GetLastReadTs() uint64 {
	if m != nil {
		return m.LastReadTs
	}
	return 0
...
func (m *PrewriteResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.LastReadTs != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintKvrpcpb(dAtA, i, uint64(m.LastReadTs))
	}
	return i, nil
}
...
func (m *PrewriteResponse) Size() (n int) {
	...
	if m.LastReadTs != 0 {
		n += 1 + sovKvrpcpb(uint64(m.LastReadTs))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastReadTs |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorKvrpcpb = []byte{
	...
	,
}
